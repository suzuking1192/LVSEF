...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--template_path", default="../data/uspto_all/templates.dat", type=str, help="Specify the path of the template.data"
    )
    parser.add_argument(
        "--template_rule_path",
    ...
    parser.add_argument("--with_all", action="store_true", default=False, help="Specify whether to use all templates.")
    parser.add_argument("--fp_dim", default=2048, type=int, help="specify the fingerprint feature dimension")
    parser.add_argument("--batch_size", default=1536, type=int, help="specify the batch size")
