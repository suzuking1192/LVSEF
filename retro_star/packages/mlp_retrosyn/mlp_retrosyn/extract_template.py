...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_folder", default="../data/uspto_all/", type=str, help="Specify the path of all template rules."
    )
    parser.add_argument("--file_name", default="proc_all_cano_smiles_w_tmpl.csv", type=str, help="Specify the filen name")
