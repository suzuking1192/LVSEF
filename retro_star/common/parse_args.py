...
# ==================== dataset ===================== #
parser.add_argument("--test_routes", default="dataset/routes_possible_test_hard.pkl")
...
# ================== one-step model ================ #
parser.add_argument("--mlp_model_dump", default="one_step_model/saved_rollout_state_1_2048.ckpt")
parser.add_argument("--mlp_templates", default="one_step_model/template_rules_1.dat")
